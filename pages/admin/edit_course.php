        ...
        <td id="page">
            ...
            <form action="" method="get">
                <table>
                    ...
                    <tr>
    					<td colspan="2"><input type="submit" name="name" value="update" onclick="this.form.action='update_course.php'"/></td>
    					<td colspan="2"><input type="submit" name="name" value="delete" onclick="this.form.action='delete_course.php'"/></td>
    				</tr>
                </table>
            </form>
        </td>
