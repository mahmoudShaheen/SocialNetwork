        ...
        <td id="page">
            ...
            <form action="" method="get">
                <table>
                    ...
                    <tr>
    					<td colspan="2"><input type="submit" name="name" value="update" onclick="this.form.action='update_component.php'"/></td>
    					<td colspan="2"><input type="submit" name="name" value="delete" onclick="this.form.action='delete_component.php'"/></td>
    				</tr>
                </table>
            </form>
        </td>
